namespace NugetForUnity
{
    ...
    public class NugetConfigFile
    {
        ...
        public void SetNewSavedRepositoryPath(string value)
        {
            SavedRepositoryPath = value;
            RepositoryPath = Environment.ExpandEnvironmentVariables(value);

            if (!Path.IsPathRooted(RepositoryPath))
            {
                string repositoryPath = Path.Combine(UnityEngine.Application.dataPath, RepositoryPath);
